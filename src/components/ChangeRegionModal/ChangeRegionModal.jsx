...
import styles from './ChangeRegionModal.module.scss';
import SelectForm from '../Select';

const ChangeRegionModal = ({ submitRegion, defaultValue, handleSelect, valueSelect }) => (
  <div className={styles.modal}>
    ...
    <div className={styles.submit}>
      <Button onClick={submitRegion} typebtn="warning">
        Выбрать
      </Button>
    </div>
  </div>
...
ChangeRegionModal.propTypes = {
  submitRegion: PropTypes.func.isRequired,
  defaultValue: PropTypes.shape({
    value: PropTypes.string.isRequired,
    label: PropTypes.string.isRequired,
  }).isRequired,
  handleSelect: PropTypes.func.isRequired,
  valueSelect: PropTypes.shape({
